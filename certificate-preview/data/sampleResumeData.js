    ...
    experience: [
      {
        ...
        description: [
          { points: "Led the development of the company's flagship product, improving performance by 40%" },
          { points: "Mentored junior developers and implemented best practices for code quality" },
          { points: "Integrated new features that increased user engagement by 25%" }
        ]
      },
      {
